...
class CrawlerHbXYAllData(Base):
    """docstring for CrawlerHbXYAllData"""

    def __init__(self):
        super(CrawlerHbXYAllData, self).__init__('http://113.57.151.5:4504/')
        self.auth = HTTPBasicAuth('邓少兵'.encode('utf-8'), 'mima123456')
    ...
    def login(self):
        ...
        if r.ok:
            ...
            data = {'__VIEWSTATE': __VIEWSTATE, '__VIEWSTATEGENERATOR': __VIEWSTATEGENERATOR,
                    '__EVENTVALIDATION': __EVENTVALIDATION, 'txtUserNme': '邓少兵', 'txtPassWord': 'mima123456',
    ...
    def pick_all(self):
        ...
        if self.login():
            # self.crawl('2020-07-01 00:00:00', '2020-07-01 17:00:00')
            self.crawl(start_date, end_date)


if __name__ == '__main__':
    xy = CrawlerHbXYAllData()
    xy.pick_all()
